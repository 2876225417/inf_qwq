...
void camera_wrapper::mousePressEvent(QMouseEvent* e) {
...
void camera_wrapper::mouseMoveEvent(QMouseEvent* e) {
    if (m_isSelecting) {
...
void camera_wrapper::mouseReleaseEvent(QMouseEvent* e) {
...
// 3. 添加绘制逻辑
void camera_wrapper::paintEvent(QPaintEvent*) {
